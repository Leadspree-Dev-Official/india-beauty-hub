...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Saundarya — Indian Modern Beauty" },
      { name: "description", content: "Saundarya is a modern Indian beautician studio offering bridal artistry, skincare, hair styling, mehendi, and occasion makeup in New Delhi." },
      { name: "author", content: "Saundarya" },
      { property: "og:site_name", content: "Saundarya" },
